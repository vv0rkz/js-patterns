...
Коллекция паттернов проектирования на JavaScript — с практическими примерами и пошаговым обучением.
...
**Функционал:**
- добавлен паттерн observer с применением для toggle theme

**Релиз:** https://github.com/vv0rkz/js-patterns/releases/tag/v1.1.0
...
- [Открытые задачи (tasks)](https://github.com/vv0rkz/js-patterns/issues?q=is:open+is:issue+label:task)
- [Активные баги (bugs)](https://github.com/vv0rkz/js-patterns/issues?q=is:open+is:issue+label:bug)
- [Все issues](https://github.com/vv0rkz/js-patterns/issues)
...
ISC © [vv0rkz](https://github.com/vv0rkz/js-patterns)
